...
class JoystickController(Node):
    ...
    def __init__(self):
        ...
        self.time_slow = self.start_time
        self.time_med = self.start_time
        self.time_fast = self.start_time
        self.vel_slow = 0.25
        self.vel_med = 0.50
        self.vel_fast = 0.90
    ...
    def _cmd_callback(self):
        ...
        if self._cmd_check:
            ...
            self.get_logger().info('Velocity of the vehicle: %f cm/s' % abs_velocity)
